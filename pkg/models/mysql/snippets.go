...
func (m *SnippetModel) Latest() ([]*models.Snippet, error) {
	...
	// Инициализируем пустой срез для хранения объектов moduls.Snippets.
	...
	for rows.Next() {
		...
		// Опять же, аргументы предоставленные в rows.Scan()
		...
		// столбцов из таблицы базы данных, возвращаемых вашим SQL запросам.
